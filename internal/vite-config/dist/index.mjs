...
const jiti = createJiti(import.meta.url, {
  "interopDefault": true,
  "alias": {
    "@vben/vite-config": "/Users/hepeichun/Code/cnb.cool/mliev/open/dwz-admin-webui/internal/vite-config"
  },
  "transformOptions": {
    "babel": {
      "plugins": []
...
/** @type {import("/Users/hepeichun/Code/cnb.cool/mliev/open/dwz-admin-webui/internal/vite-config/src/index.js")} */
const _module = await jiti.import("/Users/hepeichun/Code/cnb.cool/mliev/open/dwz-admin-webui/internal/vite-config/src/index.ts");
